        ...
        export default {
            ...
            methods: {
                checkdetail(scope,row){
                    ...
                    this.$get('article-comments/'+scope.row.id).then((res) => {
                        console.log(res)
                ...
                getcommentdetaildata(scope,row){
                    this.$get('article-comments/:'+scope.id).then((res) => {
                        console.log(res)
                    //     if(res.code===1){
                    //         this.tableData = res.info.items;
                    //         this.pages = res.info._meta.pageCount;
                ...
                getlistdata(){
                    this.$get('article-comments?sort=-id&is_child=0').then((res) => {
                        console.log(res)
                        if(res.code===1){
                            this.tableData = res.info.items;
                            this.pages = res.info._meta.pageCount;
                ...
                handleCurrentChange(val) {
                    this.loading = true
                    this.$get('article-comments?sort=-id&is_child=0', {
                        page: val,

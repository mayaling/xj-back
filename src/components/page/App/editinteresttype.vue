<template>
    <div class="table" v-loading="loading" element-loading-text="加载中">
        <div class="container">
            <div class="container-title">权益类型编辑</div>
                ...
                <el-col :span="6">
                        ...
                        <el-form :model="form" ref="form" :rules="rules" class="item-add-list">
                            ...
                            <el-form-item label="权益描述:" prop="description">
                                <el-input v-model.trim="form.description" type="text" placeholder="请输入权益描述" ></el-input>
                            </el-form-item>
                            ...
                            <router-link :to="{path:'interesttype'}"><el-button type="primary">取消</el-button></router-link>
...
<script>
    ...
    export default {
        ...
        methods: {
            // 编辑进来获取表单的内容
            getformdata(){
                this.$get('interest-types/'+this.id,).then((res) => {
                    console.log(res)
                    if(res.code===1){
            ...
            onEdit(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$put('interest-types/'+this.id, {
                            pic:this.imageurl1?this.imageurl1:this.tableData.pic,
                            name:this.form.name,
                            description:this.form.description
                        }).then((res) => {

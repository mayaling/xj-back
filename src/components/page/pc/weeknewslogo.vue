<template>
    <div class="table" v-loading="loading" element-loading-text="加载中">
        <div class="container">
            <div class="container-title">资讯图管理</div>
            <!-- <div class="mgb20">
            ...
            <el-table :data="tableData" border size="medium" ref="multipleTable"  stripe>
                <el-table-column prop="week_news_logo" label="资讯图" align="center">
                　  <template slot-scope="scope">
                　　　　<img :src="scope.row.week_news_logo" width="40" height="40" class="head_pic"/>
                　　</template>
                </el-table-column>
                <el-table-column label="操作" align="center">
                    <template slot-scope="scope">
                        <router-link :to="{path:'editweeknewslogo'}">
                            <el-button size="mini">
                               编辑
                            </el-button>
                        </router-link>

<template>
    <div class="table" v-loading="loading" element-loading-text="加载中">
        <div class="container">
            <div class="container-title">编辑bang-banner</div>
            <el-row type="flex" class="row-bg" justify="space-around">
                <el-col :span="6">
                       
                        <el-form :model="form" ref="form"  class="item-add-list">
                            <el-form-item label="外部链接:" prop="web_url">
                                <el-input v-model.trim="form.web_url" type="text"></el-input>
                            </el-form-item>
                            <el-form-item label="分享链接:" prop="share_url">
                                <el-input v-model.trim="form.share_url" type="text"></el-input>
                            </el-form-item>
                            <el-form-item label="分享标题:" prop="share_title">
                                <el-input v-model.trim="form.share_title" type="text"></el-input>
                            </el-form-item>
                            <el-form-item label="分享描述:" prop="share_desc">
                                <el-input v-model.trim="form.share_desc" type="text"></el-input>
                            </el-form-item>
                            <el-form-item prop="imageList" ref="uploadElemet">
                                ...
                                <el-button size="small" type="primary">点击上传bang-banner</el-button>
                                <span>(尺寸690*320)</span>
                                </el-upload>
                            ...
                            <router-link :to="{path:'bangbanner'}"><el-button type="primary">取消</el-button></router-link>
...
<script>
    export default {
        ...
        methods: {
            ...
            // 编辑进来获取表单的内容
            getformdata(){
                this.$get('business-banners/'+this.id,).then((res) => {
                    console.log(res)
                    if(res.code===1){
            ...
            onEdit(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$put('business-banners/'+this.id, {
                            img_url:this.imageurl1?this.imageurl1:this.tableData.img_url,
                            web_url:this.form.web_url,
                            share_url:this.form.share_url,
                            share_title:this.form.share_title,

<template>
    <div class="table" v-loading="loading" element-loading-text="加载中">
        <div class="container">
            <div class="container-title">bang类型</div>
            <div class="mgb20">
            ...
            <el-table :data="tableData" border size="medium" ref="multipleTable"  stripe>
                ...
                <el-table-column prop="logo" label="类型页logo" align="center">
                    <template slot-scope="scope">
                　　　　<img :src="scope.row.logo" width="40" height="40" class="head_pic"/>
                　　</template>
                </el-table-column>
                <el-table-column prop="index_logo" label="首页logo" align="center">
                　  <template slot-scope="scope">
                　　　　<img :src="scope.row.index_logo" width="40" height="40" class="head_pic"/>
                　　</template>
                </el-table-column>
                ...
                <el-table-column label="操作" align="center">
                    <template slot-scope="scope">
                        <router-link :to="{path:'editbangtype',query:{id:scope.row.id}}">
                            <el-button size="mini">
                               编辑
                            </el-button>
                        </router-link>
